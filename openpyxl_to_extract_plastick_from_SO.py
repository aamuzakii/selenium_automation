...
def runapps():
    ...
    newDF = result[[4851044,4851005,4851033,4851278,4851282,'app']]
    ...
    Outer_join = pd.merge(newDF, xxx, on ='app', how ='outer') 
    Outer_join = Outer_join[[4851044,4851005,4851033,4851278,4851282,'BPM Number','app']]
